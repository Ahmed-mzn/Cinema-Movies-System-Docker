              ...
              <v-col class="col-12 col-sm-6 col-md-4">
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <div class="text-uppercase blue--text">Lorem ipsum dolor</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase text-h4 mt-6 blue--text">50,00 DH</div>
                    <v-btn
                        v-bind="size"
                        rounded
                        outlined
              ...
              <v-col class="col-12 col-sm-6 col-md-4">
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <div class="text--disabled text-uppercase text-h5 my-2">Class</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">Lorem ipsum dolor</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">Lorem ipsum dolor sit consectetur</div>

                    <v-divider class="my-2"/>
                    <div class="text-uppercase text-h4 mt-6 blue--text">100,00 DH</div>
                    <v-btn
                        v-bind="size"
                        rounded
                        outlined
              ...
              <v-col class="col-12 col-md-4">
                ...
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <div class="text--disabled text-uppercase text-h5 my-2">VIP</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">Lorem ipsum dolor</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">Lorem ipsum dolor sit amet consectetur</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">Outras características...</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase text-h4 mt-6 blue--text">200,00 DH</div>
                    <v-btn
                        v-bind="size"
                        rounded
                        outlined
